...
public class ControllerCliente {
    ...
    private final ClienteRepositorio cadastraRepositorio;
    private final ClienteService cadastroService;
    ...
    public ResponseEntity<?> acessoAoLogin(@RequestBody ClienteModelo clienteModelo) {
        try {
            ClienteModelo usuarioExistente = cadastroService.validarUsuario(clienteModelo);
